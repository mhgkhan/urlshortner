...
const Hero = () => {
    return (
        <section className='hero'>
            <h1 className={`${NewRoker.className} md:text-5xl text-3xl text-blue-500 font-bold text-center my-3 flex items-center justify-center flex-wrap gap-1`}> Trim Your Links with  <span className="text-yellow-500"> GH URL SHORTNER</span></h1>
